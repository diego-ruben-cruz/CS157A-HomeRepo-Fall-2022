...
SELECT ORG.DEPTNAME as Deptname, ORG.LOCATION as Location, STAFF.NAME as Name FROM STAFF 
INNER JOIN ORG ON ORG.DEPTNUMB = STAFF.DEPT AND ORG.DEPTNAME = "Mountain" 
INNER JOIN ORG ON ORG.DEPTNUMB = STAFF.DEPT AND ORG.DEPTNAME = "Plains" 
INNER JOIN ORG ON ORG.DEPTNUMB = STAFF.DEPT AND ORG.DEPTNAME = "New England"
ORDER BY ORG.DEPTNAME, STAFF.NAME ASC;
